...
'''
Author: MuZonghan
Date: 2021-08-02 09:35:26
LastEditTime: 2021-08-19 09:39:43
Descripition: yolo格式gt和dt输出
FilePath: /4pcodes/learncodes/yolo_gtdt.py
'''
import sys
...
parser.add_argument('--root',type=str ,default='/home/trunk/muzklj/5datasets/bigdata/img-txt2', help="which should include ./images and ./labels and classes.txt")
...
colorlistgt = [(255, 255, 0), (255, 0, 0), (0, 0, 255)]
colorlistdt = [(0, 0, 0), (255, 255, 255), (255, 0, 0)]
for i in range(len(colorlistgt)):

    colorgt = np.array(colorlistgt[i])[...,::-1]
    colordt = np.array(colorlistdt[i])[...,::-1]
    # print(color)
    colorlistgt[i] = colorgt.tolist()
    colorlistdt[i] = colordt.tolist()
    # print(colorlist[i])
    ...
    if dt:
        with open(dt,'r') as f:
            ...
            for ann in annotations:
                ...
                tf = max(tl - 1, 1)  # font thickness
                # print(tf)
                t_size = cv2.getTextSize(cls2label[cls], 0, fontScale=tl / 3, thickness=1)[0]
...
if __name__ == "__main__":
    ...
    # GT_dir = os.path.join(root_path,'txt')
    # DT_dir = os.path.join(pred_path)
    # out_dir = os.path.join(root_path,'outputs')
    # cls_dir = os.path.join(root_path,'classes.txt')
    img_dir = '/home/trunk/muzklj/5datasets/bigdata/img-txt2/bus-val-img'
    GT_dir = '/home/trunk/muzklj/5datasets/bigdata/img-txt2/bus-val-img'
    DT_dir = '/home/trunk/muzklj/5datasets/bigdata/img-txt2/labels'
    out_dir = '/home/trunk/muzklj/5datasets/bigdata/img-txt2/outputs'
    cls_dir = '/home/trunk/muzklj/5datasets/bigdata/classes.txt'
    cls_dict = {}
